...
/**
	...
	contentPane.setBackground(new Color(250, 251, 253));
	...
	UIUtils.styleButton(btnNewButton, new Color(220, 53, 69));
		contentPane.add(btnNewButton);
		
		JButton add = new JButton("Buy Books");
	add.setFont(new Font("Segoe UI", Font.PLAIN, 20));
	UIUtils.styleButton(add, new Color(60, 120, 215));
	...
	UIUtils.styleButton(btnNewButton_1, new Color(52, 199, 89));
	...
	UIUtils.styleButton(button, new Color(108, 117, 125));
	...
	UIUtils.styleButton(button_1, new Color(255, 193, 7));
	...
	button_3.setFont(new Font("Segoe UI", Font.PLAIN, 20));
	UIUtils.styleButton(button_3, new Color(23, 162, 184));
		button_3.setBounds(550, 366, 264, 118);
		contentPane.add(button_3);
		
		JLabel lblNewLabel = new JLabel("Book Selling System");
	...
	lblNewLabel.setFont(new Font("Segoe UI", Font.BOLD, 34));
		...
		label.setIcon(new ImageIcon("C:\\Users\\admin\\Desktop\\Book Selling System\\why-you-should-read-and-re-read-these-high-school-books-as-an-adult (Custom) (Custom).jpeg"));
