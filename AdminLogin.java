...
public class AdminLogin extends JFrame {
	...
	//	.getContentPane().//(Toolkit.getDefaultToolkit().getImage("C:\\Users\\admin\\Desktop\\STDM.jpg"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if( ustr.equals("admin") && pstr.equals("admin123"))
				{
					dispose();
					AdminHost ah=new AdminHost();
					ah.setTitle("Book Selling System");
					ah.setVisible(true);
