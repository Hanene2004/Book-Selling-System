...
//	MainScreen frame;
	...
	AdminBtn.setFont(new Font("Segoe UI", Font.PLAIN, 28));
	UIUtils.styleButton(AdminBtn, new Color(60, 120, 215));
		AdminBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminLogin ad=new AdminLogin();
				ad.setTitle("Book Selling System");
				ad.setVisible(true);
			}
		});
	...
	UserBtn.setFont(new Font("Segoe UI", Font.PLAIN, 28));
	UIUtils.styleButton(UserBtn, new Color(52, 199, 89));
	...
	lblBuySellRecycle.setForeground(new Color(90, 90, 90));
	lblBuySellRecycle.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		lblBuySellRecycle.setBounds(136, 52, 431, 86);
		contentPane.add(lblBuySellRecycle);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\admin\\Desktop\\Book Selling System\\0 (Custom).jpg"));
